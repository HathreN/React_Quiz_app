...
function create(context) {
  ...
  async function postResult(userData) {
    const user = await ResultDAO.createNewPost(userData);
      return await ResultDAO.createOrUpdate({name: user.id, category: user.category, score: user.score});
  }
